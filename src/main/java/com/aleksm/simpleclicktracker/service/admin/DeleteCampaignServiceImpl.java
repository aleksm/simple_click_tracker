...
/**
 * Implementation of delete campaign service
 * 
 * Checks if given campaign (with given ID) exist and if does deletes it from DB. 
 * 
 * @author aleksm
 * @version 1.0.0
 */
public class DeleteCampaignServiceImpl extends BaseService<Campaign, Campaign> implements DeleteCampaignService{

	private static final Logger log = Logger.getLogger(DeleteCampaignServiceImpl.class.getName());
